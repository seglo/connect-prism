...
function Prism(logger, urlRewrite, httpEvents, proxy, mock, record, mockRecord) {
  var defaultConfig = {
    port: 80,
    https: false,
    mode: 'proxy',
...
di.annotate(Prism, new di.Inject(Logger, UrlRewrite, HttpEvents, Proxy, Mock, Record, MockRecord));
